  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Responsive: full screen on mobile, rounded on desktop
        "max-h-[90vh] sm:max-h-[85vh] rounded-t-lg sm:rounded-lg",
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn(
    ...
    "sticky top-0 z-10 bg-background px-6 pt-6 pb-4 border-b border-border",
    className
  )} {...props} />
);
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn(
    ...
    // Sticky footer with background
    "sticky bottom-0 z-10 bg-background px-6 py-4 border-t border-border",
    className
  )} {...props} />
);
